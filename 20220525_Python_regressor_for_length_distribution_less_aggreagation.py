...
MEASUREMENT_QTY_2022 = 145983 * 168/202
CATCH_2022 = 34000
...
XX_2022 = XX_2022_df.drop(columns='y').pivot(index=None,columns='lengd', values='z')
...
XX_df.columns = XX_df.columns.astype(int)
...
XX_trainR, XX_testR, yY_trainR, yY_testR = train_test_split(XX_df.loc[2000:,:],
                                                    YY.iloc[15:],
                                                    test_size=test_size,
                                                    random_state=seed)
...
xgb_regressor.fit(XX_df.loc[2000:,:], YY.iloc[15:])
...
shap_values = explainer.shap_values(XX_df.iloc[15:,:])
...
shap_values = explainer(XX_df.iloc[15:,:])
